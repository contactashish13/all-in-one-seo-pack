...
class Test_Sitemap extends Sitemap_Test_Base {
	...
	/**
	 * Test whether the URLs generated by the AMP plugin are added to the sitemap or not.
	 *
	 * @ticket 37 XML Sitemap - Add sitemap support for AMP pages.
	 */
